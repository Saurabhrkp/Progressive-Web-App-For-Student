...
router.get(
  '/dashboard/upload/document/photo',
  ensureAuthenticated,
  dashboards.document_photo_get
);

router.post(
  '/dashboard/upload/document/photo',
  ensureAuthenticated,
  dashboards.document_photo_post
);
...
router.get(
  '/dashboard/upload/document/pdf',
  ensureAuthenticated,
  dashboards.document_pdf_get
);

router.post(
  '/dashboard/upload/document/pdf',
  ensureAuthenticated,
  dashboards.document_pdf_post
);
...
router.get(
  '/dashboard/upload/document/post',
  ensureAuthenticated,
  dashboards.document_post_get
);

router.post(
  '/dashboard/upload/document/post',
  ensureAuthenticated,
  dashboards.document_post_post
);
...
router.get(
  '/dashboard/upload/notice/photo',
  ensureAuthenticated,
  dashboards.notice_photo_get
);

router.post(
  '/dashboard/upload/notice/photo',
  ensureAuthenticated,
  dashboards.notice_photo_post
);
...
router.get(
  '/dashboard/upload/notice/pdf',
  ensureAuthenticated,
  dashboards.notice_pdf_get
);

router.post(
  '/dashboard/upload/notice/pdf',
  ensureAuthenticated,
  dashboards.notice_pdf_post
);
...
router.get(
  '/dashboard/upload/notice/post',
  ensureAuthenticated,
  dashboards.notice_post_get
);

router.post(
  '/dashboard/upload/notice/post',
  ensureAuthenticated,
  dashboards.notice_post_post
);
